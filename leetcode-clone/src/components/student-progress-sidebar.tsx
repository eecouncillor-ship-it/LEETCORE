    ...
    <aside className="space-y-5">
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 flex items-end justify-between gap-4">
          ...
          <p className="text-lg text-slate-500">/ {totalCount} solved</p>
        </div>
        ...
        <p className="mt-4 text-sm text-slate-500">{completion}% complete</p>
      </section>

      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-xl font-bold text-slate-800">By Difficulty</h2>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 space-y-4 text-base">
          <div className="flex items-center justify-between">
            ...
            <span className="text-slate-600">{correctCount}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-amber-500">Incorrect</span>
            <span className="text-slate-600">{incorrectCount}</span>
          </div>
          <div className="flex items-center justify-between">
